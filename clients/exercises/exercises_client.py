...
class ExercisesClient(APIClient):
    ...
    def get_exercises_api(self, query: GetExercisesQuerySchema) -> Response:
        ...
        :param query: Объект с course_id.
    ...
    def create_exercise_api(self, request: CreateExerciseRequestSchema) -> Response:
        ...
        :param request: Объект с title, course_id, max_score, min_score, description,
    ...
    def update_exercise_api(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> Response:
        ...
        :param exercise_id: Идентификатор задания.
        :param request: Объект с параметрами для обновления задания.
        :return: Ответ от сервера в виде объекта httpx.Response
        """
    ...
    def get_exercises(self, query: GetExercisesQuerySchema) -> GetExercisesResponseSchema:
        ...
        :param query: Объект с course_id.
        :return: Объект со списком заданий.
        """
    ...
    def get_exercise(self, exercise_id: str) -> GetExerciseResponseSchema:
        ...
        :param exercise_id: Идентификатор задания.
        :return: Объект с данными задания.
        """
    ...
    def create_exercise(self, request: CreateExerciseRequestSchema) -> CreateExerciseResponseSchema:
        ...
        :param request: Объект с параметрами для создания задания.
        :return: Объект с данными созданного задания.
        """
    ...
    def update_exercise(self, exercise_id: str, request: UpdateExerciseRequestSchema) -> UpdateExerciseResponseSchema:
        ...
        :param exercise_id: Идентификатор задания.
        :param request: Объект с параметрами для обновления задания.
        :return: Объект с данными обновленного задания.
        """
